...
function init() {
    ...
    dz.on("complete", function (file) {
        ...
        var url = "https://footballer-classification.herokuapp.com/classify_image";
        ...
        $.post(url, {
            ...
            */
            ...
            let players = ["cristiano", "haaland", "karim", "lewandowski", "lionel","marcelo","neymar","pogba","vinicius"];
